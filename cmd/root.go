...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.aks.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".aks" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".aks")
	}
